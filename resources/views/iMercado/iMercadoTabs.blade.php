                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <h3 class="kt-section__title kt-section__title-sm">
                                                    Ingrese datos de Bienes:
                                                </h3>
                                            </div>
                                    </div>
                                    
                                     @include('iMercado.tabSondeoBienes')
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        <div class="row">
                                            <label class="col-xl-3"></label>
                                            <div class="col-lg-9 col-xl-6">
                                                <h3 class="kt-section__title kt-section__title-sm">Ingrese datos Servicios:</h3>
                                            </div>
                                        </div>
                                        @include('iMercado.tabSondeoBienes')
                                    </div>
