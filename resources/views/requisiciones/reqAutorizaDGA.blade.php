    ...
    <div class="kt-portlet__head kt-portlet__head--lg">
        ...
        <rect fill="#000000" x="4" y="13" width="16" height="6" rx="1.5"></rect>
            ...
            <h3 class="kt-portlet__head-title">
                Autorizar Requisiciones Dirección General de Administración
            </h3>
                                ...
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <div class="kt-form__control">
                                        <div class="dropdown bootstrap-select form-control dropup">
                                            ...
                                            <input type="text" name="status_req" id="status_req" value="3" hidden>
                            <input type="text" name="tipo" id="tipo" value="DF" hidden>
                                            ...
                                            <div class="dropdown-menu" style="max-height: 437.594px; overflow: hidden; min-height: 144px;">
                                                <div class="inner show" role="listbox" id="bs-select-1" tabindex="-1" aria-activedescendant="bs-select-1-0" style="max-height: 411.594px; overflow-y: auto; min-height: 118px;">
                                                    <ul class="dropdown-menu inner show" role="presentation" style="margin-top: 0px; margin-bottom: 0px;">
                                                        <li><a href ="../requisiciones/reqAutorizaDGA?statusReq=3" role="option" class="dropdown-item" id="bs-select-1-1" tabindex="0"><span class="text">Pendiente</span></a></li>
                                        <li><a href ="../requisiciones/reqAutorizaDGA?statusReq=4" role="option" class="dropdown-item" id="bs-select-1-2" tabindex="0"><span class="text">Tramitadas</span></a></li>
                                        <li><a href ="../requisiciones/reqAutorizaDGA?statusReq=7" role="option" class="dropdown-item" id="bs-select-1-3" tabindex="0"><span class="text">Canceladas</span></a></li>
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="local_data" style="">
                <table class="kt-datatable__table" style="display: block; text-align: center">
                    ...
                    <th width="20%" class="kt-datatable__cell kt-datatable__cell--sort"><span><center>Autorizó</center></span>
                    </th>

                    <th width="10%"  class="kt-datatable__cell kt-datatable__cell--sort"><span><center>Fecha Autorizó</center></span>
                    </th>
                ...
                <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                @if($status_req == 3 || $status_req == 4)
                                <td style="text-align: right;" width="4%"><span >
                                        <a href="getpdf/{{ $value->no_requisicion }}/{{ $value->status_req }}/DF" title="PDF" target="_self" role="button" id="imprimeResg">
                                ...
                                <td style="text-align: right;" width="6%"><center><a href="javascript:motivo_autrorizaDF({{ $value->no_requisicion }})" id="cancelados"><i class="flaticon2-notification"></i></a></center></td>
                                <td style="text-align: right;" width="2%"></td>
                                @endif
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        function motivo_autrorizaDF(noReq) {
            //console.log(noReq);
            //console.log("rfrfr");
            $(".detalleFilas").remove();
