...
<br>
        ...
        <table class="blueTable">
            ...
            <tr >
                <td width="50%" ><center><strong>{{$data2[0]->nombre_autoriza}}</strong></td>
                <td width="50%" ><center><strong>{{$data2[0]->nombre_autorizadf}}</strong></td>

            </tr>
            <tr >
                <td width="50%" ><center><strong>{{strtoupper($data2[0]->puesto_autoriza)}}</strong></td>
                <td width="50%" ><center><strong>{{strtoupper($data2[0]->puesto_autorizadf)}}</strong></td>
            </tr>
            <tr >
                <td  width="50%" ><p style="font-size: 6px; text-align: center;">{{$data2[0]->sello_autoriza}}</td>
                <td width="50%" ><p style="font-size: 6px; text-align: center;">{{$data2[0]->sello_autorizadf}}</td>
...
<html>
    ...
    <header>
        ...
        <tr>
            <td width="55%">
                <div style="margin-top: 88px; position: relative; height: 0px; font-size: 10px; float: left;margin-left: 70px"></div>
            </td>
        </tr>
...
@foreach($data as $dato)
        ...
        <table class="blueTable">
            ...
            <tr >
                <td width="50%" ><center><strong>{{$data2[0]->puesto_autoriza}}</strong></td>
                <td width="50%" ><center><strong>{{$data2[0]->puesto_autorizadf}}</strong></td>
            </tr>
            <tr >
                <td  width="50%" ><p style="font-size: 6px; text-align: center;">{{$data2[0]->sello_autoriza}}</td>
                <td width="50%" ><p style="font-size: 6px; text-align: center;">{{$data2[0]->sello_autorizadf}}</td>
