    ...
    <header>
        ...
        <tr>
            <td width="55%">
                ...
                <tr>
            <td width="55%">
                <div style="margin-top: 88px; position: relative; height: 0px; font-size: 10px; float: left;margin-right: 25px">"2020, AÑO DE LEONA VICARIO, BENEMÉRITA MADRE DE LA PATRIA"</div>
            </td>
        </tr>
...
<br>
            ...
            <tr >
                ...
                <td width="50%" ><p style="font-size: 12px"><center><strong></strong></td>
...
</script><p>Dr. Lavista 144 Acceso 3, Sótano, Col. Doctores, Del. Cuauhtémoc C.P. 06720, Tel. 5134 2500 ext. 1053.</p>
