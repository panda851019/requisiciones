...
<br>
        <table class="blueTable">
            ...
            <tr >
                <td width="50%" ><p style="font-size: 12px"><center><strong>{{$nombreCompleto}}</strong></td>
                <td width="50%" ><p style="font-size: 12px"><center><strong></strong></td>

            </tr>
            <tr >
                <td width="50%" ><p style="font-size: 12px"><center><strong>{{strtoupper($user[0]->puesto)}}</strong></td>
                <td width="50%" ><p style="font-size: 12px"><center><strong></strong></td>
            </tr>
            <tr >
