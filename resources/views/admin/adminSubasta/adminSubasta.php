            ...
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    Subasta de la Licitacion
                     @foreach ($datos as $licitacion)
                        <option value="{{ $licitacion->id }}">{{ $licitacion->nombre }}</option>
                    @endforeach
                </h3>
            </div>
                            ...
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="reportes/">Historicos</a>
                                    </h3>
                    ...
                    <div class="kt-portlet kt-iconbox kt-iconbox--brand kt-iconbox--animate-slower">
                        <div class="kt-portlet__body">
                            <div class="kt-iconbox__body">
                                ...
                                <div class="kt-iconbox__desc">
                                    <h3 class="kt-iconbox__title">
                                        <a class="kt-link" href="adminSubasta/subastaActiva">Subastas</a>
                                    </h3>
                                    <div class="kt-iconbox__content">
                                        Ir a la Subasta Actvia
                                    </div>
                                </div>
                            </div>
                        </div>
